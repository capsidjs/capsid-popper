...
exports.install = function(capsid, _temp) {
  ...
  var PopperComponent = _decorate(null, function(_initialize) {
    var PopperComponent = function PopperComponent() {
      _initialize(this)
    }
    ...
    return {
      ...
      d: [
        ...
        },
        {
          kind: 'method',
          key: 'parseJSON',
          value: function parseJSON(json, propertyName) {
            if (!json) {
              return null
            }
            ...
            try {
              ...
              console.warn(
                'Warning(capsid-popper): Can not parse the given json at ' +
                  propertyName +
                  ': ' +
                  json
              )
        ...
        },
        {
          ...
          value: function init() {
            ...
            if (!ref) {
              throw new Error(
                'popper reference not found: data-popper-ref="' +
                  popperRef +
                  '"'
              )
            }
            ...
            if (!popperPlacement) {
              throw new Error(
                'popper placement is not specified: data-popper-placement="' +
                  popperPlacement +
                  '"'
              )
            }
